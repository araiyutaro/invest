...
- [ ] 31-01-PLAN.md — fail-soft ローダー loadWatchlistJudgment（D-13 stale ガード）/ loadWatchlist を report-data-loaders.ts に新設（TDD, UI-09）
- [ ] 31-02-PLAN.md — formatWatchlistSectionHtml + カード/バッジ純関数群を generate-daily-report.ts に追加し scoringSection 直後に挿入・シグネチャ後方互換拡張（TDD, UI-09/UI-10）
...
| 31. Daily Report Watchlist Section | v2.7 | 0/3 | Not started | - |
